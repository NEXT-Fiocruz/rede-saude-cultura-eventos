<?php /* Smarty version 2.6.26, created on 2012-10-18 17:34:34
         compiled from author/submit/step4.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'author/submit/step4.tpl', 26, false),array('function', 'url', 'author/submit/step4.tpl', 35, false),array('function', 'fieldLabel', 'author/submit/step4.tpl', 74, false),array('modifier', 'escape', 'author/submit/step4.tpl', 36, false),array('modifier', 'date_format', 'author/submit/step4.tpl', 60, false),)), $this); ?>
<?php if ($this->_tpl_vars['showAbstractSteps'] && $this->_tpl_vars['currentSchedConf']->getSetting('acceptSupplementaryReviewMaterials') && ! $this->_tpl_vars['showPaperSteps']): ?>
	<?php $this->assign('pageTitle', "author.submit.step4AbstOnly"); ?>
<?php elseif ($this->_tpl_vars['showAbstractSteps'] && $this->_tpl_vars['currentSchedConf']->getSetting('acceptSupplementaryReviewMaterials')): ?>
...
<tr valign="top">
	...
	<td align="right"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'submitSuppFile','path' => $this->_tpl_vars['file']->getSuppFileId(),'paperId' => $this->_tpl_vars['paperId']), $this);?>
" class="action"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.edit"), $this);?>
</a>&nbsp;|&nbsp;<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'deleteSubmitSuppFile','path' => $this->_tpl_vars['file']->getSuppFileId(),'paperId' => $this->_tpl_vars['paperId']), $this);?>
