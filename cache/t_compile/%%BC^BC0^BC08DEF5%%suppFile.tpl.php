<?php /* Smarty version 2.6.26, created on 2012-10-26 13:05:08
         compiled from author/submit/suppFile.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'author/submit/suppFile.tpl', 18, false),array('function', 'translate', 'author/submit/suppFile.tpl', 18, false),array('function', 'fieldLabel', 'author/submit/suppFile.tpl', 28, false),array('function', 'form_language_chooser', 'author/submit/suppFile.tpl', 31, false),array('function', 'html_options_translate', 'author/submit/suppFile.tpl', 58, false),array('modifier', 'escape', 'author/submit/suppFile.tpl', 21, false),array('modifier', 'assign', 'author/submit/suppFile.tpl', 30, false),array('modifier', 'to_array', 'author/submit/suppFile.tpl', 111, false),array('modifier', 'date_format', 'author/submit/suppFile.tpl', 123, false),)), $this); ?>
<?php if ($this->_tpl_vars['showAbstractSteps'] && ! $this->_tpl_vars['showPaperSteps']): ?>
	<?php $this->assign('pageTitle', "author.submit.supplementaryFilesInfoAbstractOnly"); ?>
<?php else: ?>
...
<p><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'submit','path' => 4,'paperId' => $this->_tpl_vars['paperId']), $this);?>
...
<table width="100%" class="data">
	<tr valign="top">
		...
		<td width="80%" class="value">
			<?php echo ((is_array($_tmp=$this->_plugins['function']['url'][0][0]->smartyUrl(array('path' => $this->_tpl_vars['suppFileId'],'paperId' => $this->_tpl_vars['paperId'],'escape' => false), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'submitFormUrl') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'submitFormUrl'));?>
...
<tr valign="top">
	...
	<td width="80%" class="value"><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'download','path' => ((is_array($_tmp=$this->_tpl_vars['paperId'])) ? $this->_run_mod_handler('to_array', true, $_tmp, $this->_tpl_vars['suppFile']->getFileId()) : $this->_plugins['modifier']['to_array'][0][0]->smartyToArray($_tmp, $this->_tpl_vars['suppFile']->getFileId()))), $this);?>
...
" class="button" onclick="document.location.href='<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'submit','path' => '4','paperId' => $this->_tpl_vars['paperId']), $this);?>
'" /></p>
