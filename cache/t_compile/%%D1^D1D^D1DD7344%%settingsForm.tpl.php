<?php /* Smarty version 2.6.26, created on 2012-11-08 11:41:59
         compiled from file:/var/www/next/eventos/plugins/generic/customBlockManager/settingsForm.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'file:/var/www/next/eventos/plugins/generic/customBlockManager/settingsForm.tpl', 13, false),array('function', 'translate', 'file:/var/www/next/eventos/plugins/generic/customBlockManager/settingsForm.tpl', 15, false),array('function', 'plugin_url', 'file:/var/www/next/eventos/plugins/generic/customBlockManager/settingsForm.tpl', 20, false),array('modifier', 'assign', 'file:/var/www/next/eventos/plugins/generic/customBlockManager/settingsForm.tpl', 13, false),array('modifier', 'escape', 'file:/var/www/next/eventos/plugins/generic/customBlockManager/settingsForm.tpl', 25, false),)), $this); ?>
...
<?php echo ((is_array($_tmp=$this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'manager','op' => 'setup','path' => '4'), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'setup4') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'setup4'));?>

<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "plugin.generic.customBlockManager.introduction",'systemPluginsUrl' => $this->_tpl_vars['sysPluginsUrl'],'setupStep4' => $this->_tpl_vars['setup4']), $this);?>
...
" value="<?php echo $this->_tpl_vars['block']; ?>
...
" class="button" onclick="document.location.href='<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'manager','op' => 'plugins'), $this);?>
'" /></p>
</form>
