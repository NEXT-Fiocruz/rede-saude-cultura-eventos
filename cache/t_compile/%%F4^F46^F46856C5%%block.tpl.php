<?php /* Smarty version 2.6.26, created on 2012-10-22 13:34:26
         compiled from file:/var/www/next/eventos/plugins/blocks/user/block.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'file:/var/www/next/eventos/plugins/blocks/user/block.tpl', 12, false),array('function', 'url', 'file:/var/www/next/eventos/plugins/blocks/user/block.tpl', 19, false),array('modifier', 'escape', 'file:/var/www/next/eventos/plugins/blocks/user/block.tpl', 15, false),)), $this); ?>
...
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "plugins.block.user.myProfile"), $this);?>
			...
			<li><a class="perfil-sair" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'login','op' => 'signOut'), $this);?>
"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "plugins.block.user.logout"), $this);?>
			...
			<?php if ($this->_tpl_vars['userSession']->getSessionVar('signedInAs')): ?>
				<li><a class="perfil-sair" href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('page' => 'login','op' => 'signOutAsUser'), $this);?>
