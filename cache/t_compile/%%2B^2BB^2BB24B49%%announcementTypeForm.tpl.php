<?php /* Smarty version 2.6.26, created on 2012-10-10 08:09:19
...
<form name="announcementType" method="post" action="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'updateAnnouncementType'), $this);?>
">
...
<?php if (count ( $this->_tpl_vars['formLocales'] ) > 1): ?>
	<tr valign="top">
		...
		<td width="80%" class="value">
			...
			<?php endif; ?>
			<?php echo $this->_plugins['function']['form_language_chooser'][0][0]->smartyFormLanguageChooser(array('form' => 'announcementType','url' => $this->_tpl_vars['announcementTypeUrl']), $this);?>
